...
# ========================= CONSTANTS ============================
UNAPPROVED_MSG = (
    "`HeY! Please don't spam.Sekaru is a Very Good Boy.He has many girlfriend.Give him 5$ for approval 🙃\nMessage remaining:1 \n\n`")
# =================================================================
            ...
            if not apprv and event.text != UNAPPROVED_MSG:
                ...
                if COUNT_PM[event.chat_id] > 2:
                    await event.respond(
                        ...
                        "`You have been BLOCKED and reported as SPAM now.Now give 15$ to Sekaru's PayPal a/c for maintaining his many girlfriends or simply JUST FUCK OFF 🖕.`"
                    )
